<?php include('header.php'); ?>
        ...
        <!-- .page-content start -->
        <div class="page-content custom-background color-background blog-title page-title page-title-centered dark h-serif-font mb-30" style="background-color: #639CD7">
            <div class="container">
                <!-- .row start -->
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-md-12 blog-details mb-0">
                        <div class="post-media">
                            <img src="portfolio/details-abaris.jpg" alt=""/>
                        </div>
                    </div><!-- .col-md-12 end -->
                </div>
                <!-- .row start -->
