<?php include('header.php'); ?>
        ...
        <!-- .page-content start -->
        <div class="page-content custom-background color-background blog-title page-title page-title-centered dark h-serif-font mb-30" style="background-color: #1a1a1a">
            <div class="container">
                <!-- .row start -->
                    ...
                    <div class="col-md-12 blog-post blog-details">
                        <div class="post-body">
                            <ul class="post-meta mb-0">
                                <li class="post-date"><span>Neo-Pangea</span></li>
                            </ul>

                            <h1 class="hero-title">National Geographic</h1>
                            ...
                            <ul class="post-meta">
                                <li>
                                       ...
                                       <div class="post-tags">
                                            ...
                                            <span>User Experience <span style="opacity: .2; padding: 0 5px;"> | </span> Responsive <span style="opacity: .2; padding: 0 5px;"> | </span> Visual Design</span>
                                        </div>
                                </li>
                            </ul>
                        </div>
