...
?>
    ...
    <div class="page-content detail">
        <div class="detail__content">
            <div class="container">
                <div class="detail__content-left">
                    <h1 class="detail__content-title">Designed an app that highlights all things related to current hip-hop news.</h1>
                    <p class="detail__content-copy">DJBooth creates content for the engaged music lover, those who want to stay at the forefront of music while the rest lean back. Whether it’s breaking news stories or covering popular topics, they pride themselves on writing original, creative and personal pieces that truly connect readers. </p>
                    <p><a href="https://itunes.apple.com/us/app/the-plug-by-djbooth/id633490549" target="_blank">Download the app</a></p>
                </div>
                <div class="detail__content-right clearfix">
                    ...
                    <div class="detail__content-meta">
                        ...
                        <ul class="detail__content-list">
                            <li class="detail__content-list-item">DJBooth.net</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="detail__images">
            <img src="../portfolio/details-theplug-1.jpg" alt="" />
        </div>
        <div class="detail__screenshots">
            <div class="container">
                <img src="../portfolio/details-theplug-2.jpg" alt="" />
            </div>
        </div>
        <div class="detail__screenshots">
            <div class="container">
                <img src="../portfolio/details-theplug-3.jpg" alt="" />
            </div>
        </div>
