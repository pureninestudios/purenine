...
?>
    ...
    <div class="page-content detail">
        <div class="detail__content">
            <div class="container">
                <div class="detail__content-left">
                    <h1 class="detail__content-title">Partnered with #readysetrocket to design digital products for the NBA.</h1>
                    <p class="detail__content-copy">Experience the most incredible moments and relive all the action from a selection of the best NBA games.</p>
                ...
                <div class="detail__content-right clearfix">
                    ...
                    <div class="detail__content-meta">
                        ...
                        <ul class="detail__content-list">
                            <li class="detail__content-list-item">Ready Set Rocket</li>
                        </ul>
        ...
        <div class="detail__images">
            <img src="../portfolio/details-nba-1.jpg" alt="" />
        </div>
        <div class="detail__screenshots">
            <div class="container">
                <img src="../portfolio/details-nba-2.jpg" alt="" />
            </div>
        </div>
