                ...
                <div class="row mb-0 inner-hero">
                    ...
                    <div class="col-md-12 blog-post blog-details">
                        <div class="post-body">
                            ...
                            <h1 class="hero-title">Audiomack Mobile Apps</h1>
                            ...
                            <ul class="post-meta">
                                <li>
                                        ...
                                        <div class="post-tags">
                                            ...
                                            <span>User Experience <span style="opacity: .2; padding: 0 5px;"> | </span> Mobile Apps <span style="opacity: .2; padding: 0 5px;"> | </span> Visual Design</span>
                                        </div>
        ...
        <div class="page-content page-content--main">
            <div class="container content-wrapper-off-canvas">
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-md-12 blog-details mb-0">
                        <div class="post-media">
                            <img src="portfolio/details-am-app-1.jpg" alt=""/>
                        </div>
                    </div><!-- .col-md-12 end -->
                </div>
                <!-- .row start -->
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-md-12 blog-details mb-0">
                        <div class="post-media">
                            <img src="portfolio/details-am-app-2.jpg" alt=""/>
                        </div>
                    </div><!-- .col-md-12 end -->
                </div>
