<?php include('header.php'); ?>
        ...
        <!-- .page-content start -->
        <div class="page-content custom-background color-background blog-title page-title page-title-centered dark h-serif-font mb-30" style="background-color: #042A4F">
            <div class="container">
                <!-- .row start -->
                <div class="row mb-0">
                    <!-- .col-md-12 start -->
                    <div class="col-md-12 blog-post blog-details">
                        <div class="post-body">
                            <ul class="post-meta mb-0">
                                <li class="post-date"><span>Omnigon</span></li>
                            </ul>

                            <h1 class="hero-title">PGATour.com</h1>
